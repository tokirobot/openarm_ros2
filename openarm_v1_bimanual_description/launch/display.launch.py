...
def generate_launch_description():
    pkg_share = Path(
        launch_ros.substitutions.FindPackageShare(package="openarm_v1_bimanual_description").find(
            "openarm_v1_bimanual_description"
        )
    )
    default_model_path = pkg_share / "urdf/openarm_v1_bimanual.urdf.xacro"
        ...
        PythonLaunchDescriptionSource(
            [
                PathJoinSubstitution(
                    [
                        FindPackageShare("openarm_v1_bimanual_description"),
                        "launch",
