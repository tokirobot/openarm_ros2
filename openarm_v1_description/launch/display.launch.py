...
def generate_launch_description():
    pkg_share = Path(
        launch_ros.substitutions.FindPackageShare(package="openarm_v1_description").find(
            "openarm_v1_description"
        )
    )
    default_model_path = pkg_share / "urdf/openarm_v1.urdf.xacro"
        ...
        PythonLaunchDescriptionSource(
            [
                PathJoinSubstitution(
                    [
                        FindPackageShare("openarm_v1_description"),
                        "launch",
